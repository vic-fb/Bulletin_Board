...
INSERT INTO users (first_name, last_name, role, classroom_id)  
    VALUES ('Michael', 'Goleman', 'teacher', 1), ('Sara', 'Norgaard', 'student', 1);

INSERT INTO student_projects (user_id, title, description, image_url, project_url)  
    VALUES (2, 'Mummies', 'I researched how mummies were made in Ancient Egypt', 'https://media.istockphoto.com/photos/close-up-of-ancient-mummy-casket-picture-id139982295?k=20&m=139982295&s=612x612&w=0&h=pfmGRS8icf9lncFeljSyWJdAYJDIL-8eiLA3aqJpR60=', 'https://www.bbc.com/news/world-middle-east-56926005');
SET foreign_key_checks = 1;
